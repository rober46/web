...
<head>
    ...
    <title>Reporte de Ordenes de Operaciones</title>
    <style>
        body {
...
<div class="container">
    <h1>Reporte de Ordenes de Operaciones</h1>
    ...
    <div class="action-buttons">
        <a href="contratos.php" class="btn">Atrás</a>
...
<script>
    function imprimirReporte() {
        ...
        var contenido = document.getElementById('tablaContratos').outerHTML;
